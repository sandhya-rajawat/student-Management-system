...
<div class="flex items-center justify-center min-h-[calc(120vh-160px)]
 bg-gray-100">
  <form action="{{url('insertSchoolEvents')}}" enctype="multipart/form-data" method="POST" class="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg w-full max-w-lg">
    @csrf
